...
Sellisel juhul on kiiruse ja aja vahel vastavalt valemile \@ref(eq:velocity) lineaarne sõltuvus ehk kiirus-aeg-graafikuks peaks tulema sirge nagu joonisel \@ref(fig:velocity-time-figure):
...
```{=tex}
      \caption{Kiirus-aeg-graafik ($v$ ja $t$) ühtlaselt kiireneva liikumise puhul, kui algkiirus $v_0 := 0$} \label{fig:velocity-time-figure}
\end{figure}
```
